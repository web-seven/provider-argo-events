...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider ArgoEvents CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider ArgoEvents controllers
...
# This target prepares repo for your provider by replacing all "argoevents"
