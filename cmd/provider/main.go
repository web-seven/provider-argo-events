...
func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "ArgoEvents support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add ArgoEvents APIs to scheme")
	...
	kingpin.FatalIfError(argoevents.Setup(mgr, o), "Cannot setup ArgoEvents controllers")
