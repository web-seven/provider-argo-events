...
The [provider-argo-events](https://github.com/web-seven/provider-argo-events) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-argoevents](https://github.com/crossplane-contrib/provider-jet-argoevents) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/web-seven/provider-argo-events/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/web-seven/provider-argo-events/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/web-seven/provider-argo-events/blob/main/hack/boilerplate.go.txt](https://github.com/web-seven/provider-argo-events/blob/main/hack/boilerplate.go.txt)
...
The [provider-argo-events](https://github.com/web-seven/provider-argo-events)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/web-seven/provider-argo-events/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/web-seven/provider-argo-events/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue argoeventss (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/web-seven/provider-argo-events/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request ArgoEventss: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/web-seven/provider-argo-events/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
